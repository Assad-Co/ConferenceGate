...
const FLAGSHIP_EVENT_SOURCES: Seed[] = [
  ...
  ["summit.aps.org", "APS Global Physics Summit", "official_conference_site", "United States", "North America"],
  ["sxswedu.com", "SXSW EDU", "official_conference_site", "United States", "North America"],
  ["asee.org", "American Society for Engineering Education", "engineering_society", "United States", "North America"],
  ["aaea.org", "Agricultural & Applied Economics Association", "professional_society", "United States", "North America"],
  ["siae.fr", "Paris Air Show", "official_conference_site", "France", "Europe"],
  ["scitech.aiaa.org", "AIAA SciTech Forum", "official_conference_site", "United States", "North America"],
  ["ifama.org", "International Food and Agribusiness Management Association", "professional_association", "International", "Global"],
  ["americanbar.org", "American Bar Association", "professional_association", "United States", "North America"],
  ["isa-sociology.org", "International Sociological Association", "professional_association", "International", "Global"],
  ["aaslh.org", "American Association for State and Local History", "professional_association", "United States", "North America"],
  ["wtm.com", "World Travel Market", "official_conference_site", "United Kingdom", "Europe"],
  ["phocuswrightconference.com", "The Phocuswright Conference", "official_conference_site", "United States", "North America"],
